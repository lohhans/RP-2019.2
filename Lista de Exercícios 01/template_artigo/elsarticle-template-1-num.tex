...
\title{Teste An\'alise de algor\'itmos de reconhecimento de padr\~oes}
...
\begin{abstract}
%% Text of abstract
O objetivo principal desse trabalho foi o a elabora\c c\~ao e o estudo de dois algor\'itmos para sistemas de reconhecimento de padr\~oes. Tais programas foram o algor\'itmo da \'Arvore de Decis\~ao e o algor\'itmo de Naive Bayes. Inicialmente s\~ao mostrados os conceitos b\'asicos sobre reconhecimento de padr\~oes e sobre cada algor\'itmo de decis\~ao acima citado. Depois haver\'a uma apresenta\c c\~ao das t\'ecnicas usadas na an\'alise e as devidas conclus\~oes.
\end{abstract}
...
Partindo dessas aformativas, o presente artigo exp\~oe um estudo que busca a an\'alise comparativa de dois algor\'itmos. O algor\'itmo da \'Arvore de Decis\~ao e o algor\'itmo de Naive Bayes, ambos voltados a classifica\c c\~ao de dados baseando-se nos princ\'ipios do reconhecimento de padr\~oes.
\section{Refer\êncial Te\'orico}
\label{S:2}

\subsection{Reconhecimento de Padr\~oes}

\subsection{Algor\'itmo da \'Arvore de Decis\~ao}

\subsection{Algor\'itmo de Naive Bayes}
